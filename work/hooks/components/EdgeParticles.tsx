  ...
  useEffect(() => {
    ...
    function step() {
      ...
      for (const p of particles) {
        ...
        // Bleu outremer (--accent), pas la variante --link (trop pâle pour
        // rester visible comme poussière ambiante à faible opacité).
        ctx!.fillStyle = `rgba(42,77,255,${p.opacity})`;
        ctx!.fill();
      }
